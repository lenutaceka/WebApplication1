...
namespace WebApplication1.Controllers
{
    public class CourseController : Controller
    {
        ...
        {
            ViewBag.TitleSortParam = string.IsNullOrEmpty(sortOrder) ? "titlename_desc" : "";
            ViewBag.CreditsSortParam = string.IsNullOrEmpty(sortOrder) ? "credit_desc" : " ";
            var courses = from c in db.Courses select c; //clonam db students a.i sa nu modific db studentul intruna la fiecare sortare
